<template>
  <li
    ...
    :class="{
      'AppTabsListItem__pink--active':
        color === 'pink' && activeItem === index + 1,
      'AppTabsListItem__orange--active':
        color === 'orange' && activeItem === index + 1,
      'AppTabsListItem__peach--active':
        color === 'peach' && activeItem === index + 1,
