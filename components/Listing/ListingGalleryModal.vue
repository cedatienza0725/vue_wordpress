<template>
  <div class="ListingGalleryModal">
    <div class="ListingGalleryModal__header">
      <div class="ListingGalleryModal__close" @click.prevent="closeModal()">
        <font-awesome-icon
    ...
    <div class="ListingGalleryModal__content">
      ...
      >
        <ListingGalleryModalSlider
          v-if="!this.$device.isMobile"
          :list="list"
          :currentIndex="currentIndex"
          :followActiveSlide="currentIndex"
          @activeIndex="activeIndex"
        />
        <ListingGalleryModalMobileSlider
          v-else
          :list="list"
          :currentIndex="currentIndex"
          :followActiveSlide="currentIndex"
...
export default {
  ...
  methods: {
    ...
    activeIndex(value) {
      ...
      const element = list.getElementsByClassName("ListingGalleryModal__item")[
        this.currentIndex
      ];
      if (!element) {
        return;
