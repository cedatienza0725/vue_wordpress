  ...
  <div class="HomeLearn">
    <div class="container">
      <div class="row">
        ...
        <div
          class="col-12 col-md-7 d-flex align-items-center justify-content-end h-80"
        >
          <AppTabsList
            id="tabLearnItems"
            ref="learnList"
    ...
    <div
      ...
      :key="index"
      class="HomeLearn__block"
      :class="{
        'HomeLearn__block--image-right': item.tab_layout === 'media_right',
        'HomeLearn__block--image-left': item.tab_layout === 'media_left',
      }"
    >
      <div class="HomeLearn__wrapper">
        <div class="HomeLearn__content">
          ...
          <div
            v-for="(link, linkIndex) in item.tab_sub_links"
            :key="linkIndex"
            class="HomeLearn__field"
          >
            <AppLink
              type="common"
              color="black"
              :text="link.sub_links.title"
              :navigate-to="link.sub_links.url"
              style="
                font-weight: normal;
                font-size: 18px;
                white-space: nowrap;
          ...
          <div v-if="item.tab_link" class="HomeLearn__action">
            <AppLinkButton
              color="orange"
