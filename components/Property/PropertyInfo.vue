    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-md-6">
          ...
          <h1 v-if="info.property_address" class="PropertyInfo__name">
            {{ info.property_address }}
          </h1>

          <h2 v-if="info.property_title" class="PropertyInfo__address">
            {{ info.property_title }}
          </h2>

          <p v-if="info.descriptive_title" class="PropertyInfo__description">
        ...
        <div class="col-12 col-md-5 d-flex flex-column justify-content-end">
          <div class="PropertyInfo__top">
            ...
            <p v-if="info.property_type" class="PropertyInfo__type">
    ...
    return {
      list: [
        ...
        },
        {
          ...
          value: `${this.info.living_area
            .toString()
            .replace(/(\d)(?=(\d{3})+$)/g, "$1,")} Sq. Ft.`,
        },
        {
          name: this.info.lot_size_title,
          value: `${this.info.lot_size
            .toString()
            .replace(/(\d)(?=(\d{3})+$)/g, "$1,")} Sq. Ft.`,
        },
      ],
