      ...
      <div class="row">
        <div class="col-12 col-md-5">
          <div class="CommunityMarketing__title">
            <AppSectionTitle :title="marketing.section_heading" />
          </div>
        </div>
      ...
      <div class="row pt-lg-50">
        <div class="col-12 col-lg-8 pt-sm-20">
          <iframe
            ...
            frameborder="0"
            allowfullscreen=""
            style="border: none; width: 100%; height: 50vw"
          >
          </iframe>
        </div>
        <div class="col-12 col-lg-4 pt-sm-20">
          <div
            ...
            :class="{
              'CommunityMarketing__wrapper--active': activeItem === index + 1,
            }"
          >
            <div class="CommunityMarketing__item">
              ...
              <div class="CommunityMarketing__action">
                <AppButton
                  color="pink"
                  type="small"
                  :text="item.tab_link.title"
                  @click.native="redirect(item.tab_link.url)"
                />
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    getUrl() {
      return `https://e.infogram.com/${
        this.marketing.tabbed_content[this.activeItem - 1].tab_data
          ?.split("data-id=")[1]
          ?.split('"')[1]
      }`;
    },
    ...
    getTitle() {
      return this.data?.split("data-title=")[1]?.split('"')[1];
    },
