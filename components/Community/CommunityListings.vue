  ...
  methods: {
    makeCards() {
      if (this.listings.featured_listings) {
        const cards = this.listings.featured_listings
          .filter((property) => {
            return !!property.mls_data;
          })
          .map((property) => {
            // eslint-disable-next-line
            const full = property.mls_data.address.full
              .replace(/\s/g, "-")
              .replace(/[&\/\\#,+()$~%.'":*?<>{}]/g, "")
              .replace(/--/g, "-");
            ...
            return {
              ...
              description: property.mls_data.property.lotDescription
                ? property.mls_data.property.lotDescription
                : "",
              ...
              bath:
                property.mls_data.property.bathsFull +
                property.mls_data.property.bathsHalf,
