<template>
  <section class="BlogCategories">
    ...
    <div class="container">
      <AppSectionTitle :title="categories.page_title" class="text-center" />
      ...
      <div v-if="blogCategoryLoading" class="BlogCategories__loading">
        <AppLoader />
      </div>

      <BlogCardsList :list="newList" />
...
export default {
  ...
  methods: {
    ...
    async updateImageUrl() {
      ...
      this.categories.content_data.forEach((item) => {
    ...
    async navigateToPage(pageNumber) {
      ...
      try {
        await this.getBlogCategory(queryParams);
        this.updateImageUrl();
      } catch (err) {
        console.log(err);
      }
