<template>
  <section class="BlogContent">
    <img class="BlogContent__star" :src="head.background_image" alt="star" />
    ...
    <div class="container">
      <AppSectionTitle :title="head.title" class="text-center" />

      <span class="BlogContent__subtitle" v-html="head.body" />
      ...
      <div class="BlogContent__article">
        ...
        <div class="BlogContent__search" @click.prevent="searchLocation()">
          <font-awesome-icon
            class="fa-lg"
            style="color: white; height: 1em"
            :icon="['fas', 'search']"
          />
        </div>
      ...
      <div v-for="(row, index) in content.category_blogs" :key="index">
        <BlogContentList :list="row" />
      </div>
    </div>
  </section>
</template>
