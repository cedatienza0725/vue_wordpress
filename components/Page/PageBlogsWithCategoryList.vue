<template>
  <div class="PageBlogsWithCategoryList">
    <div class="PageBlogsWithCategoryList__info">
      ...
      <AppLink :text="list.category_link.title" :navigate-to="list.category_link.url" color="grey"
        style="padding-bottom: 18px" />
    </div>

    <div class="PageBlogsWithCategoryList__list">
      <BlogCard v-for="(item, index) in newList" :key="index" :item="item" />
    </div>
  </div>
</template>
