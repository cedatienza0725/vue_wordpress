<template>
  <div>
    ...
    <SearchHomeListingsTile
      v-if="(!isMap && tableView) || checkData.propertiessearch.length < 1"
      :listing="checkData"
      :is-author="isAuthor"
    />

    <SearchHomeListingsTileMap
      v-if="isMap && searchHome.propertiessearch.length > 0"
      :listing="checkData"
      :is-author="isAuthor"
    />
        ...
        form: {
          ...
          status: {
            ...
            list: [
              ...
              {
                text: "In Escrow",
                value: "ActiveUnderContract&status=Pending",
              },
              { text: "Sold", value: "Closed" },
            ],
          },
          price: {
            label: "Price:",
